...
1. Sample rate was set to 96kHz — I had the hardware to push this, and biased towards fidelity. Technically, I believe the DJM-S5 only outputs at 48khz, so that's probably the cap on my gear, but YMMV depending on your mixer (or if you have a rig that outputs directly).
