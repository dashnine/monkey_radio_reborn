...
Much of the rotation has been tracked down. These haven't.
{:.lead}

These are the tracks for which I only have a story: no label, no Discogs entry, no
storefront, sometimes barely a confirmed name. They're station
exclusives, lost media, or both....and every lead I've chased has so far hit a
wall.

**If you recognize any of these - know the artist, remember the release, or
(best of all) have a copy - please [ping me on Reddit](https://www.reddit.com/user/AltitudeMatters).**
Even a half-memory might be the thread that unravels one of these. Here's
everything I've managed to dig up so far.
